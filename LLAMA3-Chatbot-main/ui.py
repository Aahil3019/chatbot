...
class LoginWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Aahil Kedia Chatbot Login")
    ...
    def check_login(self):
        ...
        if username == "aahil" and password == "aahil@123":
            self.close()
            self.open_chatbot()
        else:
...
class ChatbotWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Aahil Kedia Chatbot")
    ...
    def send_message(self):
        ...
        if message:
            ...
            self.chat_display.append("<p style='color: #888;'><i>Aahil Kedia Chatbot is thinking...</i></p>")
    ...
    def display_response(self, user_message):
        ...
        self.chat_display.append(f"<p style='color: #66cc99;'><b>Aahil Kedia Chatbot:</b> {response}</p>")
